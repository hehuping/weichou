       ...
       <!-- <div class="col-md-3">
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-primary">
                ...
                <form class="form-horizontal" onsubmit="return tosend()" action="/backend/manager/dochange?goods_id=<?php echo $_GET['goods_id']; ?>" method="post">
                <div class="panel-body">
                    <select class="form-control" id="cate" name="cate">
                        <?php foreach($cate as $v){ ?>
                        <option value="<?php echo ($now["cid"]); ?>"><?php echo ($now["catename"]); ?></option>
                    ...
                    <div style="height: 10px;"></div>
                        <div class="form-group">
                            ...
                            <input type="text" id="title" value="<?php echo ($goods["title"]); ?>" name="title" placeholder="请输入标题..." class="form-control" />
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="money" value="<?php echo ($goods["target_money"]); ?>" name="money" placeholder="请输入目标金额..." class="form-control" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" id="times" value="<?php echo ($goods["cycle"]); ?>" name="time" placeholder="请输入项目展示周期..." class="form-control" />
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-2" id="ss">
                            ...
                            <input type="hidden" name="re" id="ready" value="4" />
                        </div>

                        <?php foreach($goods['images'] as $k=>$v){ ?>
                        <div class="col-md-2" id="s<?php echo $k+1; ?>">
                            <img src="/Public/images/delete_512px_1175751_easyicon.net.png" class="deletes" onclick="del(<?php echo $k+1; ?>,'<?php echo $v; ?>')">
                            <img class="select img-rounded" src="/teimg/<?php echo $v; ?>" alt="image"><input type="hidden" name="img<?php echo $k+1; ?>" value="<?php echo $v; ?>">
                        </div>
                        <?php } ?>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <script type="text/plain" id="myEditor" style="width:100%;height:240px;"><?php echo ($goods["content"]); ?></script>
                            </div>
